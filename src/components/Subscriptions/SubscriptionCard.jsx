...
const SubscriptionCard = ({ type, rate }) => {
  ...
  return (
    ...
    >
      ...
      <button onClick={handleNavigate} className="w-full h-10 mt-4 rounded-md hover:opacity-90 bg-[#028EE6] text-white text-sm font-medium">
        View Details
      </button>
