...
const Filter = () => {
  return (
    ...
    <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      <div class="flex flex-col">
        ...
        <input
          ...
          class="mt-2 block w-full rounded-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:border-[#028EE6] focus:ring focus:ring-blue-200 focus:ring-opacity-50"
        />
      </div>
    ...
    <div class="mt-6 grid w-full grid-cols-2 justify-end space-x-4 md:flex">
      ...
      <button class={`active:scale-95 rounded-lg px-8 py-2 font-medium text-white outline-none focus:ring focus:ring-blue-200 hover:opacity-90 ${styles.blueBg}`}>
        Search
      </button>
    </div>
  </div>
